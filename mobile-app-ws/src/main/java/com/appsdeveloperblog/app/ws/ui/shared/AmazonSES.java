...
public class AmazonSES {
		...
		final String HTMLBODY = "<h1>Please verify your email address</h1>"
				...
				+ "<a href='http://13.232.51.141:8080/verification-service/email-verification.html?token=$tokenValue'>"
		...
		final String TEXTBODY = "Please verify your email address"
				...
				+ "http://13.232.51.141:8080/verification-service/email-verification.html?token=$tokenValue"
		...
		final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
				...
				+ "<a href='http://13.232.51.141:8080/verification-service/password-reset.html?token=$tokenValue'>"
		...
		final String PASSWORD_RESET_TEXTBODY = "A request to reset your password"
				...
				+ "otherwise, please click on the link below to set a new password: "
				+ "http://13.232.51.141:8080/verification-service/password-reset.html?token=$tokenValue"
				+ "Click this link to reset the password"
				+"Thank you!";
